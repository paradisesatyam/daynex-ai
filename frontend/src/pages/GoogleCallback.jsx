...
export default function GoogleCallback({ onLogin }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080810", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Outfit',sans-serif", color:"#9898b8", fontSize:15 }}>
      {status}
    </div>
  )
}
